...
class TestT3Cases:
    ...
    def test_all_cases_defined(self):
        from simulations.run_transition_t3 import T3_CASES
...
class TestCorrelations:
    ...
    def test_blasius_at_re_1e5(self):
        ...
        from simulations.run_transition_t3 import cf_blasius
    ...
    def test_turbulent_higher_than_laminar(self):
        ...
        from simulations.run_transition_t3 import cf_blasius, cf_turbulent_power
        rex = np.array([1e6])
    ...
    def test_schlichting_vs_power_law_similar(self):
        ...
        from simulations.run_transition_t3 import cf_turbulent_power, cf_turbulent_schlichting
        rex = np.array([1e6])
    ...
    def test_abu_ghannam_shaw_monotonic(self):
        ...
        from simulations.run_transition_t3 import re_theta_onset_abu_ghannam_shaw
    ...
    def test_rex_from_re_theta_blasius_relation(self):
        ...
        from simulations.run_transition_t3 import re_x_from_re_theta
        re_th = 100.0
...
class TestConfigGeneration:
    ...
    def test_lm_config_generated(self, tmp_path):
        from simulations.run_transition_t3 import T3_CASES, generate_su2_config_lm
        case = T3_CASES["T3A"]
    ...
    def test_bcm_config_generated(self, tmp_path):
        from simulations.run_transition_t3 import T3_CASES, generate_su2_config_bcm
        case = T3_CASES["T3B"]
    ...
    def test_fully_turbulent_config_no_transition(self, tmp_path):
        from simulations.run_transition_t3 import T3_CASES, generate_su2_config_fully_turbulent
        case = T3_CASES["T3A"]
    ...
    def test_config_uses_inc_rans(self, tmp_path):
        ...
        from simulations.run_transition_t3 import (
...
class TestResultParsing:
    ...
    def test_compute_rex(self):
        from simulations.run_transition_t3 import compute_rex
    ...
    def test_find_transition_from_synthetic_cf(self):
        ...
        from simulations.run_transition_t3 import find_transition_location
